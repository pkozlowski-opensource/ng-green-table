import {ChangeDetectorRef, Component, NgModule, VERSION} from '@angular/core';
...
export class AppComponent {
  ...
  _random(max: number) { return Math.round(Math.random() * 1000) % max; }

  itemById(index: number, item: Data) { return item.id; }
